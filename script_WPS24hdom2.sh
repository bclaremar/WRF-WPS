...
#    echo $t
	...
	cd ../DATA
        cmd="curl -s --disable-epsv --connect-timeout 60 -u anonymous:bjorn.claremar@uppmax.uu.se -o GFSd${dds}_t${hhs}z_${fh} https://www.ftp.ncep.noaa.gov/data/nccf/com/gfs/prod/gfs.2022${mms}${dds}/${hhs}/atmos/gfs.t${hhs}z.pgrb2.0p25.f0${fh}"
        echo $cmd
        eval $cmd >& error.log
	cd ../WPS
...
../WRF_dmpar/run/script_WRF24h_dom2.sh
sleep 60
../WRF_dmpar/run2/script_WRF24h_dom2.sh
